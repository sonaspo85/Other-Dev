...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="a">
        <xsl:variable name="certain_url" select="'https://www.samsung.com/us/Legal/SamsungLegal-EULA4/#SPANISH'" />
        <xsl:choose>
            ...
            <xsl:when test="parent::li and @href=$certain_url and 
                            following-sibling::a[@href=$certain_url]">
                <xsl:if test="matches(., '^\s+')">
                    <xsl:text>&#x20;</xsl:text>
                </xsl:if>
            ...
            <xsl:when test="parent::li and @href=$certain_url and 
                            preceding-sibling::a[@href=$certain_url]">
            </xsl:when>
