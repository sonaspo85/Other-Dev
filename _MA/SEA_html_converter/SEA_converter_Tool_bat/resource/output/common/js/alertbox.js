        ...
        messageBox: function(type, message, properties, input) {
            $(this).chain(function() {
                ...
                if (type == 'alert' || type == 'info' || type == 'error') {
                    ...
                    $('#BoxAlertBtnOk, #BoxAlertBtnHome').val(properties.textBoxBtnOk).css({
                        'border': '0px',
                    ...
                    $('#BoxConfirmBtnOk').val(properties.textBoxBtnOk).css({
                        'width': 70
                    });
                    $('#BoxConfirmBtnCancel').val(properties.textBoxBtnCancel).css({
                        'width': 70
                    });
                    ...
                    $('#BoxPromptBtnOk').val(properties.textBoxBtnOk).css({
                        'width': 70
                    });
                    $('#BoxPromptBtnCancel').val(properties.textBoxBtnCancel).css({
                        'width': 70
                    });
