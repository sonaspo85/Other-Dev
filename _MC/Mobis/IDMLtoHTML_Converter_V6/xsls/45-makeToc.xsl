...
<xsl:stylesheet 
    ...
    <xsl:template match="/topic">
        <xsl:variable name="TocFile" select="'../output/toc2.html'" />
                        ...
                        <div id="con_list2">
                            <div id="id_toc2">
                                <xsl:for-each select="topic[@idml]">
                                    <h1 class="toc-chap2" data-style="Chapter">
                                        <a href="#">
                                    ...
                                    <ul class="toc-sect2">
                                        <xsl:for-each select="topic[1]/topic[@file]">
                                            ...
                                            <li>
                                                ...
                                                <!--<xsl:if test="descendant::h2">
                                                    <ul class="toc-sect">
                                                        <xsl:for-each select="descendant::h2">
                                                            <li>
                                                                <a>
                                                                    <xsl:attribute name="href" select="concat($cur/@file, '#', position() - 1)" />
                                                                    <xsl:value-of select="." />
                                                                </a>
                                                            </li>
                                                        </xsl:for-each>
