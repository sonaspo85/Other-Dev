                ...
                <xsl:variable name="temp">
                    <xsl:choose>
                        ...
                        <xsl:when test="@class='UL1_1-Note' and 
                                        following-sibling::*[1][@class='Step-UL2_1-Note']">
                            <xsl:variable name="flw" select="following-sibling::*[1][@class='Step-UL2_1-Note']"/>
                            <ul>
                                <xsl:apply-templates select="@*" />
                                <xsl:for-each select="node()">
                                    <xsl:copy>
                        ...
                        <xsl:when test="@class='Step-UL2_1-Note' and 
