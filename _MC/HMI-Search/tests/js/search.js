$(document).ready(function() {
	$('#part').on('change', function(e) {
		if ($(this).val() == "MOBIS") {
			let arr = [ 'ALB', 'ARA-AS', 'ARA-EU', 'AZE', 'BEN', 'BUL', 'BUR', 'CRO', 'CZE', 'DAN', 'DUT', 'EST', 'FAR', 'FIN', 'GEORGIAN', 'GER', 'GRE', 'HEB', 'HIN', 'HKG', 'HUN', 'IND', 'ITA', 'JPN', 'KAZ', 'LAO', 'LAT', 'LIT', 'Main-KHM', 'Vendor-KHM', 'MAL', 'Malta', 'MKD', 'MON', 'NOR', 'POL', 'POR', 'ROM', 'RUS', 'SER', 'SG-CHI', 'SC2ENG', 'SLK', 'SLV', 'SPA', 'Ltn-SPA', 'SWE', 'THA', 'TPE', 'TUR', 'UKR', 'URD', 'UZB', 'VIE', 'Zawgyi-BUR', 'Noto-BUR' ];
