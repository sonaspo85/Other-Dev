...
var fontLists = ['SamsungOne-400', 'SamsungOneKorean-400', 'SamsungOneArabic-400', 'SamsungOneHebrew-400', 'Tahoma', 'SamsungOneMyanmar-400', 'SamsungSVDMedium_T_CN', 'SamsungSVDMedium_S_CN'];
...
function convertSVG2AI(doc, aplFont) {
    ...
    for (var x=0;x<tf.length;x++) {
        ...
        for (var z=0;z<paras.length;z++) {
            ...
            if (aplFont == "SamsungOneArabic-400" || aplFont == "SamsungOneHebrew-400" || aplFont == "Tahoma") {
                paras[z].paragraphAttributes.composerEngine = ComposerEngineType.optycaComposer;
                paras[z].paragraphAttributes.everyLineComposer = true;
            }
        }
    }
