...
set CLASSPATH=%DITA_DIR%lib\Saxon-HE-9.8.0-12.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\ast.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.9.6.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.9.6.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jing-2.0.0.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.lwdita\lib\org.lwdita-2.0.7.jar;%CLASSPATH%
