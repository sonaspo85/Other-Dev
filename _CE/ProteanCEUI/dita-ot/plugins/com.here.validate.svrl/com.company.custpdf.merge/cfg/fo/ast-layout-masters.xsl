      ...
      <fo:repeatable-page-master-alternatives>
        <xsl:if test="$first">
	        <xsl:choose>
	          ...
	          <xsl:otherwise>
          		<fo:conditional-page-master-reference master-reference="{$master-reference}-first" odd-or-even="odd" page-position="first"/>
	          </xsl:otherwise>
	        </xsl:choose>
        </xsl:if>
        <xsl:if test="$last">
	        <xsl:choose>
	          ...
	          <xsl:otherwise>
          		<fo:conditional-page-master-reference master-reference="{$master-reference}-last" odd-or-even="odd" page-position="last"/>
	          </xsl:otherwise>
	        </xsl:choose>
        </xsl:if>
        <xsl:choose>
