...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:import xmlns:dita="http://dita-ot.sourceforge.net" href="plugin:com.company.custpdf.html5:cfg/fo/xsl/ast-pagebreak.xsl"/><xsl:import href="plugin:com.company.custpdf.merge:cfg/fo/xsl/ast-pagebreak.xsl"/>
