...
NEW_CLASSPATH="$DITA_DIR/lib/Saxon-HE-9.8.0-12.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/lib/ast.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/lib/jackson-core-2.9.6.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jackson-databind-2.9.6.jar:$NEW_CLASSPATH"
NEW_CLASSPATH="$DITA_DIR/lib/jing-2.0.0.jar:$NEW_CLASSPATH"
...
NEW_CLASSPATH="$DITA_DIR/plugins/org.lwdita/lib/org.lwdita-2.0.7.jar:$NEW_CLASSPATH"
