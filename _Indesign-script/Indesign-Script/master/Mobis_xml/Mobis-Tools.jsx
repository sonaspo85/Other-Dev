...
var main = new Window ("palette", "Mobis Tools v.0.1.5");
...
var btn_17 = panel_02.add("button", [0, 0, 180, 30], "모든 문서 열기");
var btn_18 = panel_02.add("button", [0, 0, 180, 30], "모든 문서 저장 닫기");
...
btn_17.onClick = function() { // 북파일 문서 열기
	if (app.books.length == 0) {
		alert(noBook);
	} else if (app.books.length > 0) {
...
btn_18.onClick = function() { // 열린 문서 저장 후 닫기
	var docs = app.documents;
	for (var i=docs.length-1; i >= 0; i--) {
		docs[i].close(SaveOptions.YES);
	}
	alert("모든 문서를 저장 후 닫았습니다.");
}
