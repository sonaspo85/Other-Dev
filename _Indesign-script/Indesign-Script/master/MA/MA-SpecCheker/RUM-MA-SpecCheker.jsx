...
var w = new Window ('palette {text: "RUM 사양 Check"}');
	//w.main = w.add ('group');
...
btn_02.onClick = function () {//Dual SIM 과금 문구 추가
	...
	function main() {
		...
		var source_file = File("C:/MA-WikiSpec/RUM/MA_online_UM_Rum_DualSIM_spec.indd"); // 사양문장 템플릿 문서 열기
		app.open(source_file);
		var source_doc = app.documents.item("MA_online_UM_Rum_DualSIM_spec.indd");
