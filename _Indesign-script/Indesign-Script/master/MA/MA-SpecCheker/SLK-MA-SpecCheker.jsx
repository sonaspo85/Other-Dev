...
var w = new Window ('palette {text: "SLK 사양 Check"}');
	//w.main = w.add ('group');
	...
	group01.orientation = "row";
		btn_02 = group01.add("button", [0, 0, 150, 30], "콜론 뒤 대문자 적용");
		btn_04 = group01.add("button", [0, 0, 150, 30], "-");
...
btn_01.onClick = function () {
	if(app.documents.length < 1){
		...
		for (var i=0; i < doc.length; i++){
			...
			app.findTextPreferences.findWhat = "Vyberanie batérie";
