...
else if (app.books.length > 0)
{
    try
    {
        ...
        var vbscript = ''''version()
                            Function version
                                Dim myURL
                                myURL = "http://download.astkorea.net/InDesignScript/Configuration_M3_2022.xlsx"
                                Dim WinHttpReq
                                ...
                                objStream.SaveToFile "''' + path + '''\\Configuration_M3_2022.xlsx", 2
                                objStream.Close
        ...
        var vbscript = '''Main()
                                Sub Main()
                                    ...
                                    Set book = app.WorkBooks.Open("''' + path + '''\\Configuration_M3_2022.xlsx")
...
function Headings(mydoc)
{
    ...
    for (var i=0 ; i<story_count ; i++)
    {
        ...
        for (var j=0 ; j<para_count ; j++)
        {
            ...
            } else if (paras[j].appliedParagraphStyle.name.search('Chapter') > -1 && paras[j].appliedParagraphStyle.name.search('Description') < 0) {
                h1 = 0;
                h2 = 0;
                h3 = 0;
                h4 = 0;
