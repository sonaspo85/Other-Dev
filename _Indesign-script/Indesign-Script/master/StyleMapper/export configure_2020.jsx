...
function Applink(mydoc)
{
    ...
    try {
        ...
        alert (e + " 오류 발생 스타일: " + paras[j].appliedParagraphStyle.name + "\r" + "오류 발생 이전의 문장 : " + paras[j-1].contents + "\r" + "위 문장 이후의 APPLINK 스타일 문장에 잘못된 스타일이 적용됐을 가능성이 있습니다. 문서를 확인해보세요.");
    }
}
