...
function _eXportXML(doc) {
	...
	if (textRefs.length > 0) {
		...
		for (var i=0; i<textRefs.length; i++){
			...
			var tcontents = tFrame.contents.replace(/\r/g, " ").replace("","").replace("►", "&#x25BA;").replace("►", "&#x25BA;").replace(/\•/g, "&#x2022;").replace(/\→/g, "&#x2192;").replace(/\■/g, "&#x25A0;").replace(/\↓/g, "&#x2193;").replace(/\↑/g, "&#x2191;").replace(/\←/g, "&#x2190;").replace(/"/g, "&quot;").replace("     ","").replace(/\</g, "&lt;").replace(/\>/g, "&gt;");
			var trealcont = tFrame.contents.replace(/\r/g, "&#xD;").replace("","").replace("►", "&#x25BA;").replace("►", "&#x25BA;").replace(/\•/g, "&#x2022;").replace(/\→/g, "&#x2192;").replace(/\■/g, "&#x25A0;").replace(/\↓/g, "&#x2193;").replace(/\↑/g, "&#x2191;").replace(/\←/g, "&#x2190;").replace(/"/g, "&quot;").replace(/\</g, "&lt;").replace(/\>/g, "&gt;");
			var tWords = tFrame.words;
			var jcount = 0
			paraStyle = tFrame.textRange.paragraphStyles[0].name;
			if (paraStyle == "[표준 단락 스타일]") {
				paraStyle = "None"
			}
